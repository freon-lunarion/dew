...
class OmSetup extends CI_Model{
  ...
  public function InsertDemoRecords($offset = 0,$hldComp = 1)
  {
    ...
    $set = array(
      ...
      array($this->config->item('relAssign'), $hldComp, (19 + $offset) ),
      array($this->config->item('relChief'), $hldComp, (19 + $offset) ),
      array($this->config->item('relAssign'), (2 + $offset), (20 + $offset) ),
      array($this->config->item('relChief'), (2 + $offset), (20 + $offset) ),
      array($this->config->item('relAssign'), (3 + $offset), (21 + $offset) ),
      array($this->config->item('relChief'), (3 + $offset), (21 + $offset) ),
      array($this->config->item('relAssign'), (4 + $offset), (22 + $offset) ),
      array($this->config->item('relChief'), (4 + $offset), (22 + $offset) ),
      array($this->config->item('relAssign'), (5 + $offset), (23 + $offset) ),
      array($this->config->item('relChief'), (5 + $offset), (23 + $offset) ),
      array($this->config->item('relAssign'), (6 + $offset), (24 + $offset) ),
      array($this->config->item('relChief'), (6 + $offset), (24 + $offset) ),
      array($this->config->item('relAssign'), (7 + $offset), (25 + $offset) ),
      array($this->config->item('relChief'), (7 + $offset), (25 + $offset) ),
      array($this->config->item('relAssign'), (8 + $offset), (26 + $offset) ),
      array($this->config->item('relChief'), (8 + $offset), (26 + $offset) ),
      array($this->config->item('relAssign'), $hldComp , (27 + $offset) ),
      array($this->config->item('relAssign'), (2 + $offset), (28 + $offset) ),
      array($this->config->item('relAssign'), (3 + $offset), (29 + $offset) ),
      array($this->config->item('relAssign'), (4 + $offset), (30 + $offset) ),
      array($this->config->item('relAssign'), (4 + $offset), (31 + $offset) ),
      array($this->config->item('relAssign'), (4 + $offset), (32 + $offset) ),
      array($this->config->item('relAssign'), (4 + $offset), (33 + $offset) ),
      array($this->config->item('relAssign'), (4 + $offset), (34 + $offset) ),
      array($this->config->item('relAssign'), (5 + $offset), (35 + $offset) ),
      array($this->config->item('relAssign'), (5 + $offset), (36 + $offset) ),
      array($this->config->item('relAssign'), (5 + $offset), (37 + $offset) ),
      array($this->config->item('relAssign'), (5 + $offset), (38 + $offset) ),
      array($this->config->item('relAssign'), (5 + $offset), (39 + $offset) ),
      array($this->config->item('relAssign'), (5 + $offset), (40 + $offset) ),
      array($this->config->item('relAssign'), (6 + $offset), (41 + $offset) ),
      array($this->config->item('relAssign'), (6 + $offset), (42 + $offset) ),
      array($this->config->item('relAssign'), (6 + $offset), (43 + $offset) ),
      array($this->config->item('relAssign'), (6 + $offset), (44 + $offset) ),
      array($this->config->item('relAssign'), (6 + $offset), (45 + $offset) ),
      array($this->config->item('relAssign'), (7 + $offset), (46 + $offset) ),
      array($this->config->item('relAssign'), (7 + $offset), (47 + $offset) ),
      array($this->config->item('relAssign'), (7 + $offset), (48 + $offset) ),
      array($this->config->item('relAssign'), (8 + $offset), (49 + $offset) ),
      array($this->config->item('relAssign'), (8 + $offset), (50 + $offset) ),
      array($this->config->item('relHold'), (19 + $offset), (51 + $offset) ),
      array($this->config->item('relHold'), (20 + $offset), (52 + $offset) ),
      array($this->config->item('relHold'), (21 + $offset), (53 + $offset) ),
      array($this->config->item('relHold'), (22 + $offset), (54 + $offset) ),
      array($this->config->item('relHold'), (23 + $offset), (55 + $offset) ),
      array($this->config->item('relHold'), (24 + $offset), (56 + $offset) ),
      array($this->config->item('relHold'), (25 + $offset), (57 + $offset) ),
      array($this->config->item('relHold'), (26 + $offset), (58 + $offset) ),
      array($this->config->item('relHold'), (27 + $offset), (59 + $offset) ),
      array($this->config->item('relHold'), (28 + $offset), (60 + $offset) ),
      array($this->config->item('relHold'), (29 + $offset), (61 + $offset) ),
      array($this->config->item('relHold'), (30 + $offset), (62 + $offset) ),
      array($this->config->item('relHold'), (31 + $offset), (63 + $offset) ),
      array($this->config->item('relHold'), (32 + $offset), (64 + $offset) ),
      array($this->config->item('relHold'), (33 + $offset), (65 + $offset) ),
      array($this->config->item('relHold'), (34 + $offset), (66 + $offset) ),
      array($this->config->item('relHold'), (35 + $offset), (67 + $offset) ),
      array($this->config->item('relHold'), (36 + $offset), (68 + $offset) ),
      array($this->config->item('relHold'), (37 + $offset), (69 + $offset) ),
      array($this->config->item('relHold'), (38 + $offset), (70 + $offset) ),
      array($this->config->item('relHold'), (39 + $offset), (71 + $offset) ),
      array($this->config->item('relHold'), (40 + $offset), (72 + $offset) ),
      array($this->config->item('relHold'), (41 + $offset), (73 + $offset) ),
      array($this->config->item('relHold'), (42 + $offset), (74 + $offset) ),
      array($this->config->item('relHold'), (43 + $offset), (75 + $offset) ),
      array($this->config->item('relHold'), (44 + $offset), (76 + $offset) ),
      array($this->config->item('relHold'), (45 + $offset), (77 + $offset) ),
      array($this->config->item('relHold'), (46 + $offset), (78 + $offset) ),
      array($this->config->item('relHold'), (47 + $offset), (79 + $offset) ),
      array($this->config->item('relHold'), (48 + $offset), (80 + $offset) ),
      array($this->config->item('relHold'), (49 + $offset), (81 + $offset) ),
      array($this->config->item('relHold'), (50 + $offset), (82 + $offset) ),
